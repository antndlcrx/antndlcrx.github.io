...
```bash
# Clone the repo
git clone https://github.com/Oxford-LLMs-Research/oxford-llms-site.git
cd oxford-llms-site

# Install dependencies (like `bundle install` in Jekyll)
npm install
```
...
The site will be live in ~2 minutes. The workflow is in `.github/workflows/deploy.yml`.
