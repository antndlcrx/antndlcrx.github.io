...
I am a human geographer integrating social sciences to inform agricultural, food, and nutritional policy and development programs, including plant breeding initiatives. My research interests focus on the critical and ethical application of natural language processing (NLP), large language models (LLMs), and other AI tools in these areas. To know more, visit my personal [website](www.dumisanizmoyo.org).
